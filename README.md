...
🎓 B.Tech CSE Final Year Student | Aspiring Software Developer  
💻 Interested in .NET, Android Development & AI-based applications  
🚀 Currently building projects and strengthening C#, SQL & problem-solving skills  
...
- Frameworks & Tools: .NET, Android (Kotlin), Git, GitHub  
- Concepts: OOP, DSA, LINQ, DBMS, Basics of ML  

---

## 📌 Featured Projects
🔹 **AI Resume Analyzer** – Resume screening using NLP concepts  
🔹 **IndiaGovNews App** – Android app for government news & user feedback  
🔹 **Image-Based Wealth Estimation** – ML-based socioeconomic analysis  
🔹 **.NET & SQL Training Repos** – Daily structured backend practice  
